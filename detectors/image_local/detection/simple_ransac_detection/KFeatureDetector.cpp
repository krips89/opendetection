...
KFeatureDetector::KFeatureDetector(string type, bool use_gpu)
{
...
void KFeatureDetector::computeKeypointsAndDescriptors(cv::Mat const &image, cv::Mat &descriptors,
...
void KFeatureDetector::findSiftGPUDescriptors1(cv::Mat const &image, cv::Mat &descriptors,
                                             vector<cv::KeyPoint> &keypoints) {
...
void KFeatureDetector::findSiftGPUDescriptors(cv::Mat const &image, cv::Mat &descriptors,
                                              vector<cv::KeyPoint> &keypoints) {
...
void KFeatureDetector::findSiftGPUDescriptors(char const *image_name, cv::Mat &descriptors,
                                             vector<cv::KeyPoint> &keypoints) {
