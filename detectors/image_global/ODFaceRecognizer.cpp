...
namespace od
{
  void ODFaceRecognizer::init()
  {
    switch (recogtype_)
    {
      case OD_FACE_FISCHER: cvrecognizer_ = cv::face::createFisherFaceRecognizer(num_components_, threshold_); break;
      case OD_FACE_EIGEN: cvrecognizer_ = cv::face::createEigenFaceRecognizer(num_components_, threshold_); break;
      default: std::cout << "FATAL: FACETYPE NOT FOUND!";
    }
  }
